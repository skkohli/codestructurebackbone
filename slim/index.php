...
function connecteEx($query){

    //this line will connect to the database and return a link variable 
    $link = mysqli_connect("localhost", "root", "new-password", "todo");
...
$app->get(
    ...
    function ($id) {
                ...
                $data->description = "this is the slim description";
...
$ob1 = new StdClass();
$ob1->name = "Exilant";
$ob1->address = "modify to ur requirement";
$ob1->doc = "19 Jan 2002";
$ob1->services = "Modify it";

echo json_encode($ob1);
...
$ob1 = new StdClass();
$ob1->title = "Exilant title";
$ob1->content = "modify to ur requirement";
echo json_encode($ob1);
